      ...
      <div className='container-carousel'>
        <div className="carousel w-full z-index-0" >
          <div id="slide1" className="carousel-item relative w-full">
            ...
            <img src="https://daisyui.com/images/stock/photo-1625726411847-8cbb60cc71e6.jpg" className="w-full h-full" />
            <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
              <div><br></br><br></br>
                <h1 className="text-4xl font-bold" style={{ marginLeft: 200 }}>VISI DAN MISI</h1>
                <h1 className="text-4xl font-bold" style={{ marginLeft: 200 }}>DESA MARGASANA</h1>
                <hr className="blue-line-carousel" style={{ marginLeft: 200 }} />
              </div>
            </div>
          </div>
        </div >
